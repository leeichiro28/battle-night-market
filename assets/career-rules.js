...
window.CareerRules = (function () {
  function html() {
    return `
      ...
      <p>每升一級送1技能點，花點可以把「戰技」跟三個永久被動(暴擊精研／博學被動／勤奮掛機)分別升到 <b style="color:var(--gold);">Lv.1 → Lv.2 → Lv.3</b>，等級越高效果越好。這些等級<b style="color:var(--ink);">永久保留</b>，換下一場活動、下一個賽季也不會歸零，只會越練越強。</p>
